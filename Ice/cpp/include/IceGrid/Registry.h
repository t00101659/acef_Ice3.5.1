...
public:
    ...
    ICE_GRID_API ::Ice::Int end_getACMTimeout(const ::Ice::AsyncResultPtr&);
    
private:

    ICE_GRID_API ::Ice::Int getACMTimeout(const ::Ice::Context*);
    ICE_GRID_API ::Ice::AsyncResultPtr begin_getACMTimeout(const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
