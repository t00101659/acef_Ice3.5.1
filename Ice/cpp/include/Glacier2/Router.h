...
class GLACIER2_API AMD_Router_refreshSession : virtual public ::Ice::AMDCallback
{
public:
...
class Callback_Router_getACMTimeout_Base : virtual public ::IceInternal::CallbackBase { };
...
private:
    ...
    ::Ice::AsyncResultPtr __begin_getACMTimeout(const ::Ice::Context* __ctx, const ::IceInternal::Function<void (::Ice::Int)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent)
    {
        ...
        return begin_getACMTimeout(__ctx, new Cpp11CB(__response, __exception, __sent));
    }
...
public:
    ...
    ::Ice::AsyncResultPtr begin_getACMTimeout(const ::Glacier2::Callback_Router_getACMTimeoutPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_getACMTimeout(0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_getACMTimeout(const ::Ice::Context& __ctx, const ::Glacier2::Callback_Router_getACMTimeoutPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_getACMTimeout(&__ctx, __del, __cookie);
    }

    GLACIER2_API ::Ice::Int end_getACMTimeout(const ::Ice::AsyncResultPtr&);
    
private:

    GLACIER2_API ::Ice::Int getACMTimeout(const ::Ice::Context*);
    GLACIER2_API ::Ice::AsyncResultPtr begin_getACMTimeout(const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
...
public:
    ...
    virtual ::Ice::Int getACMTimeout(const ::Ice::Context*, ::IceInternal::InvocationObserver&) = 0;
};
...
public:
    ...
    virtual ::Ice::Int getACMTimeout(const ::Ice::Context*, ::IceInternal::InvocationObserver&);
};
...
public:
    ...
    virtual void refreshSession_async(const ::Glacier2::AMD_Router_refreshSessionPtr&, const ::Ice::Current& = ::Ice::Current()) = 0;
