...
public:
    ...
    Ice::ConnectionIPtr create(const std::vector<EndpointIPtr>&, bool, Ice::EndpointSelectionType, bool&,bool bmanulchangetimeout =false);
    void create(const std::vector<EndpointIPtr>&, bool, Ice::EndpointSelectionType, 
		const CreateConnectionCallbackPtr&, bool bmanulchangetimeout = false);
