    ...
    _implicitContext(0)
{
    try
    {
        __setNoDelete(true);
        {
            LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::Instance] Enter Instance.");
                                                       ...
                                                       defaultServerACM);
        {
            ...
            LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::Instance] _messageSizeMax=%d.", (int)_messageSizeMax);
        }
        ...
        LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::Instance] Create RouterManager successfully.");

        _locatorManager = new LocatorManager(_initData.properties);
        LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::Instance] Create LocatorManager successfully.");

        _referenceFactory = new ReferenceFactory(this, communicator);
        LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::Instance] Create ReferenceFactory successfully.");

        _proxyFactory = new ProxyFactory(this);
        LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::Instance] Create ProxyFactory successfully.");
        ...
        LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::Instance] Create EndpointFactoryManager successfully.");
#ifndef ICE_OS_WINRT
        EndpointFactoryPtr tcpEndpointFactory = new TcpEndpointFactory(this);
        _endpointFactoryManager->add(tcpEndpointFactory);
        LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::Instance] Create TcpEndpointFactory successfully.");
#else
        ...
        LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::Instance] Create StreamEndpointFactory successfully.");
        ...
        LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::Instance] Create UdpEndpointFactory successfully.");

        _dynamicLibraryList = new DynamicLibraryList;
        LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::Instance] Create DynamicLibraryList successfully.");

        _pluginManager = new PluginManagerI(communicator, _dynamicLibraryList);
        LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::Instance] Create PluginManagerI successfully.");

        _outgoingConnectionFactory = new OutgoingConnectionFactory(communicator, this);
        LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::Instance] Create OutgoingConnectionFactory successfully.");

        _servantFactoryManager = new ObjectFactoryManager();
        LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::Instance] Create ObjectFactoryManager successfully.");

        _objectAdapterFactory = new ObjectAdapterFactory(this, communicator);
        LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::Instance] Create ObjectAdapterFactory successfully.");
        
        _retryQueue = new RetryQueue(this);
        LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::Instance] Create RetryQueue successfully.");

        if(_initData.wstringConverter == 0)
        {
            _initData.wstringConverter = new UnicodeWstringConverter();
            LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::Instance] Create UnicodeWstringConverter successfully.");
        }
           ...
           _initData.properties->getProperty("Ice.Admin.Endpoints") != "")
        {
            ...
            LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::Instance] Create CommunicatorObserverI successfully.");
        ...
        LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::Instance] Leave Instance.");
...
{
	LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::finishSetup] START.");
    //
    // Load plug-ins.
    //
    assert(!_serverThreadPool);
	...
	LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::finishSetup] Load plug-ins successfully.");
	...
	LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::finishSetup] Set observer updater successfully.");
	...
	LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::finishSetup] Create threads successfully.");
	...
	LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::finishSetup] Get default router and locator proxies successfully.");
	...
	LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::finishSetup] initializePlugins successfully.");
	...
	LOG(CSystemLog::LOG_SYSTEM, "[IceInternal::Instance::finishSetup] END.");
}

bool
IceInternal::Instance::destroy()
{
    LOG(CSystemLog::LOG_SYSTEM, "Instance::destroy");
    {
        IceUtil::RecMutex::Lock sync(*this);
...
{
    LOG(CSystemLog::LOG_SYSTEM, "ProcessI::shutdown");
