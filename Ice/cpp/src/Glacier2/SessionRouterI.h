...
public:
    ...
    void unexpectedCreateSessionException(const Ice::Exception&,std::string );
...
private:
	...
	bool startCreateSession(const CreateSessionPtr&, const std::string & ,const Ice::ConnectionPtr&);
